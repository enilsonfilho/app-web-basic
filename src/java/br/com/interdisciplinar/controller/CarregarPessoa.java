...
public class CarregarPessoa extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.setAttribute("pessoa", Pesdao.carregar(idPessoa));
            request.setAttribute("tipos", Pessoa.Tipo.values());
            request.getRequestDispatcher("cadastro/perfil.jsp").forward(request, response);
        } catch (Exception ex) {
            System.out.println("Problemas ao carregar Colaboradores! Erro:" + ex.getMessage());
            ex.printStackTrace();
        }
    }
