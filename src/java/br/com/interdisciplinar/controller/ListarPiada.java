 ...
 */
@WebServlet(name = "ListarPiada", urlPatterns = {"/ListarPiada"})
public class ListarPiada extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.setAttribute("piadas", dao.listar());
            request.getRequestDispatcher("suapiada/listar.jsp").forward(request, response);
        } catch (Exception ex) {
