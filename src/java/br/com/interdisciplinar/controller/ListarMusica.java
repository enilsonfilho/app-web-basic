 ...
 */
@WebServlet(name = "ListarMusica", urlPatterns = {"/ListarMusica"})
public class ListarMusica extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
         ...
         try {
            ...
            request.setAttribute("musicas", dao.listar());
            request.getRequestDispatcher("suamusica/listar.jsp").forward(request, response);
        } catch (Exception ex) {
