 ...
 */
@WebServlet(name = "ExcluirCharada", urlPatterns = {"/ExcluirCharada"})
public class ExcluirCharada extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            dao.excluir(id);
            request.getRequestDispatcher("ListarCharada").forward(request, response);
        } catch (Exception ex) {
