 ...
 */
@WebServlet(name = "ExcluirPiada", urlPatterns = {"/ExcluirPiada"})
public class ExcluirPiada extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            dao.excluir(id);
            request.getRequestDispatcher("ListarPiada").forward(request, response);
        } catch (Exception ex) {
