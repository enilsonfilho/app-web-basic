 ...
 */
@WebServlet(name = "ListarCharada", urlPatterns = {"/ListarCharada"})
public class ListarCharada extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.setAttribute("charadas", dao.listar());
            request.getRequestDispatcher("suacharada/listar.jsp").forward(request, response);
        } catch (Exception ex) {
