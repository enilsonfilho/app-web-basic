 ...
 */
@WebServlet(name = "ExcluirPoesia", urlPatterns = {"/ExcluirPoesia"})
public class ExcluirPoesia extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            dao.excluir(id);
            request.getRequestDispatcher("ListarPoesia").forward(request, response);
        } catch (Exception ex) {
