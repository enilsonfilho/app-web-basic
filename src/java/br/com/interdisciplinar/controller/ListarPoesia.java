 ...
 */
@WebServlet(name = "ListarPoesia", urlPatterns = {"/ListarPoesia"})
public class ListarPoesia extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.setAttribute("poesias", dao.listar());
            request.getRequestDispatcher("suapoesia/listar.jsp").forward(request, response);
        } catch (Exception ex) {
