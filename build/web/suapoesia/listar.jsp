    ...
    <body>
        ...
        <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
            ...
            <ul class="nav menu">
                ...
                <li class="active"><a href="ListarPoesia"><em class="fa fa-heart-o">&nbsp;</em> Poemas</a></li>
                ...
                <li class=""><a href="ListarCharada"><em class="fa fa-object-group">&nbsp;</em> Charadas</a></li>
                    <%
                        if (pessoa.isAdm()) {
                    %>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
            <div class="row">
                <ol class="breadcrumb">
                    ...
                    <li class="active">Poesias</li>
                </ol>
            </div><!--/.row-->

            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Publique a sua poesia</h1>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            ...
                            <button type="button" class="btn btn-default btn-lg" id="myBtn"> Nova poesia</button>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body table-responsive">
                            <table class="table table-bordered table-dark" id="tabela">
                                ...
                                <tbody>
                                    <c:forEach var="poesia" items="${poesias}">
                                        <tr>
                                            <td scope="row">${poesia.conteudo}</td> 
                                            <td scope="row">${poesia.autor}</td> 
                                            <td scope="row"><fmt:formatDate type="date" value="${poesia.data}" pattern="dd/MM/yyyy"></fmt:formatDate></td>
                                            <%
                                                if (pessoa.isAdm()) {
                                            %>
                                            <td><a href="${pageContext.request.contextPath}/ExcluirPoesia?id=${poesia.id}"> Excluir </a></td>
                                            <td><a type="button" data-toggle="modal" data-target="#${poesia.id}" > Editar </a></td>  
                                            <%
                                                }
                                            %>
                                        ...
                                        <!-- Formulário Modal -->
                                    <div class="container">
                                        <div class="modal fade" id="${poesia.id}" role="dialog">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                        <h4> <div id="tituloModal">Editar poesia</div></h4>
                                                    </div>
                                                    <div class="modal-body">
                                                        <form name="cadastrar" action="${pageContext.request.contextPath}/SalvarPoesia" role="form" method="post">
                                                            <div class="form-group">
                                                                <label for="usrname"> Id</label>
                                                                <input class="form-control" placeholder="Id" name="id" type="number" autofocus="" value="${poesia.id}" data-ls-module="charCounter" readonly="" autocomplete="off">
                                                            </div>

                                                            <div class="form-group">
                                                                <label for="psw"> Conteúdo</label>
                                                                <input class="form-control" placeholder="Conteúdo..." name="conteudo" type="text" autofocus="" value="${poesia.conteudo}" data-ls-module="charCounter" maxlength="200" required="" autocomplete="off">
                                                            </div>

                                                            <div class="form-group">
                                                                <label for="psw"> Autor</label>
                                                                <input class="form-control" placeholder="Autor..." name="autor" type="text" autofocus="" value="${poesia.autor}" data-ls-module="charCounter" maxlength="50" required="" autocomplete="off">
                                                            </div>

                                                            <div class="form-group">
                                                                <label for="psw"> Data de Publicação</label>
                                                                <input class="form-control" placeholder="00/00/0000" name="data" type="date" autofocus="" value="${poesia.data}" data-ls-module="charCounter" maxlength="50" required="" autocomplete="off">
                                                            </div>
            ...
            <div class="modal fade" id="myModal" role="dialog">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                            <h4> <div id="tituloModal">Novo poesia</div></h4>
                        </div>
                        <div class="modal-body">
                            <form name="cadastrar" action="${pageContext.request.contextPath}/SalvarPoesia" role="form" method="post">
                                <div class="form-group">
        ...
        <script>
            var dados = [
            <c:forEach var="poesia" items="${poesias}">
                ['${poesia.conteudo}', 'De <b>${poesia.autor}</b> publicada em <b>${poesia.dataFormatada}</b>',
                        '<a href="${pageContext.request.contextPath}/ExcluirPoesia?id=${poesia.id}">Excluir</a> / <a type="button" data-toggle="modal" data-target="#${poesia.id}" > Editar</a>'],
            </c:forEach>
            ];
