    ...
    <body>
        ...
        <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
            ...
            <ul class="nav menu">
                ...
                <li class="active"><a href="ListarFrase"><em class="fa fa-comments">&nbsp;</em> Frases</a></li>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Publique a sua frase</h1>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            ...
                            <button type="button" class="btn btn-default btn-lg" id="myBtn"> Nova frase</button>
                            ...
                            <table class="table table-bordered table-dark" id="tabela">
                                ...
                                <tbody>
                                    <c:forEach var="frase" items="${frases}">
                                        <tr>
                                            <td scope="row">${frase.conteudo}</td> 
                                            <td scope="row">${frase.autor}</td> 
                                            <td scope="row"><fmt:formatDate type="date" value="${frase.data}" pattern="dd/MM/yyyy"></fmt:formatDate></td>
                                            <%
                                                if (pessoa.isAdm()) {
                                            %>
                                            <td><a href="${pageContext.request.contextPath}/ExcluirFrase?id=${frase.id}"> Excluir </a></td>
                                            <td><a type="button" data-toggle="modal" data-target="#${frase.id}" > Editar </a></td>  
                                            <%
                                                }
                                            %>
                                        ...
                                        <!-- Formulário Modal -->
                                    <div class="container">
                                        <div class="modal fade" id="${frase.id}" role="dialog">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                        <h4> <div id="tituloModal">Editar Frase</div></h4>
                                                    </div>
                                                    <div class="modal-body">
                                                        <form name="cadastrar" action="${pageContext.request.contextPath}/SalvarFrase" role="form" method="post">
                                                            <div class="form-group">
                                                                <label for="usrname"> Id</label>
                                                                <input class="form-control" placeholder="Id" name="id" type="number" autofocus="" value="${frase.id}" data-ls-module="charCounter" readonly="" autocomplete="off">
                                                            </div>

                                                            <div class="form-group">
                                                                <label for="psw"> Conteúdo</label>
                                                                <input class="form-control" placeholder="Conteúdo..." name="conteudo" type="text" autofocus="" value="${frase.conteudo}" data-ls-module="charCounter" maxlength="200" required="" autocomplete="off">
                                                            </div>

                                                            <div class="form-group">
                                                                <label for="psw"> Autor</label>
                                                                <input class="form-control" placeholder="Autor..." name="autor" type="text" autofocus="" value="${frase.autor}" data-ls-module="charCounter" maxlength="50" required="" autocomplete="off">
                                                            </div>

                                                            <div class="form-group">
                                                                <label for="psw"> Data de Publicação</label>
                                                                <input class="form-control" placeholder="00/00/0000" name="data" type="date" autofocus="" value="${frase.data}" data-ls-module="charCounter" maxlength="50" required="" autocomplete="off">
                                                            </div>
            ...
            <div class="modal fade" id="myModal" role="dialog">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                            <h4> <div id="tituloModal">Novo frase</div></h4>
                        </div>
                        <div class="modal-body">
                            <form name="cadastrar" action="${pageContext.request.contextPath}/SalvarFrase" role="form" method="post">
                                <div class="form-group">
        ...
        <script>
            var dados = [
            <c:forEach var="frase" items="${frases}">
                ['" ${frase.conteudo} "', 'De <b>${frase.autor}</b> publicada em <b>${frase.dataFormatada}</b>',
                        '<a href="${pageContext.request.contextPath}/ExcluirFrase?id=${frase.id}">Excluir</a> / <a type="button" data-toggle="modal" data-target="#${frase.id}" > Editar</a>'],
            </c:forEach>
            ];
