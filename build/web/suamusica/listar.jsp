    ...
    <body>
        ...
        <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
            ...
            <ul class="nav menu">
                ...
                <li class="active"><a href="ListarMusica"><em class="fa fa-music">&nbsp;</em> Músicas</a></li>    
        ...
        <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Publique a sua letra de música</h1>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            ...
                            <button type="button" class="btn btn-default btn-lg" id="myBtn"> Nova música</button>
                            ...
                            <table class="table table-bordered table-dark" id="tabela">
                                ...
                                <tbody>
                                    <c:forEach var="musica" items="${musicas}">
                                        <tr>
                                            <td scope="row">${musica.conteudo}</td> 
                                            <td scope="row">De ${musica.autor} publicada em <fmt:formatDate type="date" value="${musica.data}" pattern="dd/MM/yyyy"></fmt:formatDate></td> 
                                            
                                            <%
                                                if (pessoa.isAdm()) {
                                            %>
                                            <td><a href="${pageContext.request.contextPath}/ExcluirMusica?id=${musica.id}"> Excluir </a></td>
                                            <td><a type="button" data-toggle="modal" data-target="#${musica.id}" > Editar </a></td>  
                                            <%
                                                }
                                            %>
                                        ...
                                        <!-- Formulário Modal -->
                                    <div class="container">
                                        <div class="modal fade" id="${musica.id}" role="dialog">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                        <h4> <div id="tituloModal">Editar Letra</div></h4>
                                                    </div>
                                                    <div class="modal-body">
                                                        <form name="cadastrar" action="${pageContext.request.contextPath}/SalvarMusica" role="form" method="post">
                                                            <div class="form-group">
                                                                <label for="usrname"> Id</label>
                                                                <input class="form-control" placeholder="Id" name="id" type="number" autofocus="" value="${musica.id}" data-ls-module="charCounter" readonly="" autocomplete="off">
                                                            </div>

                                                            <div class="form-group">
                                                                <label for="psw"> Conteúdo</label>
                                                                <input class="form-control" placeholder="Conteúdo..." name="conteudo" type="text" autofocus="" value="${musica.conteudo}" data-ls-module="charCounter" maxlength="200" required="" autocomplete="off">
                                                            </div>

                                                            <div class="form-group">
                                                                <label for="psw"> Autor</label>
                                                                <input class="form-control" placeholder="Autor..." name="autor" type="text" autofocus="" value="${musica.autor}" data-ls-module="charCounter" maxlength="50" required="" autocomplete="off">
                                                            </div>

                                                            <div class="form-group">
                                                                <label for="psw"> Data de Publicação</label>
                                                                <input class="form-control" placeholder="00/00/0000" name="data" type="date" autofocus="" value="${musica.data}" data-ls-module="charCounter" maxlength="50" required="" autocomplete="off">
                                                            </div>
            ...
            <div class="modal fade" id="myModal" role="dialog">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                            <h4> <div id="tituloModal">Nova música</div></h4>
                        </div>
                        <div class="modal-body">
                            <form name="cadastrar" action="${pageContext.request.contextPath}/SalvarMusica" role="form" method="post">
                                <div class="form-group">
        ...
        <script>
            var dados = [
            <c:forEach var="musica" items="${musicas}">
                ['${musica.conteudo}', 'De <b>${musica.autor}</b> publicada em <b>${musica.dataFormatada}</b>',
                        '<a href="${pageContext.request.contextPath}/ExcluirMusica?id=${musica.id}">Excluir</a> / <a type="button" data-toggle="modal" data-target="#${musica.id}" > Editar</a>'],
            </c:forEach>
            ];
